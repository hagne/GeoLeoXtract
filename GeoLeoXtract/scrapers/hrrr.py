...
class Scraper(object):
    def __init__(self,
                 ...
                 # name = 'surfrad',
                 #satellite = '16',
                 p2fld_out = '~/tmp/hrrr/res',
                 pattern = 'projected_{date}.nc', #ABI_L2_AOD_projected2surfrad_20230813.nc
                 p2fld_tmp = '~/tmp/hrrr/tmp',
                 frequency = 'D',
                 start = '2020-01-01',
                 end = '2024-01-01',
    ...
    def process_single_chunk(self,row, 
        ...
        cstart = cend = row.name
        # cend = cstart + _pd.to_timedelta(1,self.frequency)
                
        try:
            query = _glx.cloud_interface.AwsQueryHRRR(path2folder_local=self.p2fld_tmp,
                                  start=cstart,
                                  end=cend,
                                  # process=None,
                                  forcast_intervals = self.forcast_intervals,
                                  overwrite=True,
                                )  
